...
ENTERPRISE_CATEGORIES = {
    "产业资本": {
        "label": "产业资本",
        "l2": ["产业基金", "VC", "行业媒体", "养老咨询", "养老信息平台", "养老REIT", "行业研究", "资讯门户", "康复器械", "慢病管理", "SaaS", "智能硬件", "上门", "AI", "保险", "远程医疗", "膳食配送", "陪伴社交"],
    },
    "养老服务": {
        "label": "养老服务",
        "l2": ["居家护理", "适老化", "改造", "养老运营", "上门", "远程护理", "护理协调", "陪伴社交", "护工平台", "SaaS", "持续照料社区", "远程监护", "康养地产", "远程医疗", "家政生活服务", "养老机构", "保险", "智能硬件", "专业护理", "养老人才培训", "康复医疗", "康复器械", "护理者支持", "陪诊", "居家医疗", "殡葬服务", "长护险经办", "安宁疗护", "慢病管理", "助行器", "养老膳食", "养老信息平台", "SDOH", "健康管理", "认知症"],
    },
    "医疗健康": {
        "label": "医疗健康",
        "l2": ["慢病管理", "远程医疗", "智能硬件", "SaaS", "认知训练", "保险", "认知数字疗法", "健康服务平台", "诊所", "护士上门", "药品", "安宁疗护", "远程监护", "体检筛查", "睡眠监测", "更年期", "远程护理", "康复医疗", "居家医疗", "AI医疗", "陪伴社交", "心理健康", "AI", "用药提醒", "神经调控", "SDOH", "健康管理", "认知症", "抗衰老药物", "居家护理", "医疗器械", "药品配送", "认知筛查", "糖尿病管理", "居家康复", "跌倒监测", "康复器械", "用药管理", "保健品", "护士派遣", "视觉辅助", "养老机构", "中医养生", "阿尔茨海默药物", "智能药盒", "上门", "专业护理", "营养食品", "护理协调", "膳食配送", "紧急呼叫", "膳食补充剂", "养老运营", "养老信息平台", "康养地产", "VC", "就业", "尿失禁", "美妆护肤", "个性化营养", "护理者支持", "助听器"],
    },
    "康复辅具": {
        "label": "康复辅具",
        "l2": ["康复器械", "智能硬件", "助听器", "助行器", "外骨骼", "轮椅", "护理床", "机器人", "助听辅具", "适老化", "神经调控", "跌倒监测", "行业媒体", "慢病管理", "上门", "陪伴社交", "远程医疗", "医疗器械", "资讯门户", "保险", "AI"],
    },
    "文娱社交": {
        "label": "文娱社交",
        "l2": ["陪伴社交", "文娱", "兴趣社群", "机器人", "健身", "教育", "旅游", "资讯门户", "短视频直播", "相亲", "就业", "社区", "AI", "邻里社交", "远程医疗", "行业媒体", "SaaS", "居家护理", "持续照料社区", "康养地产", "智能硬件", "护工平台", "跌倒监测", "保险科技", "AI医疗", "助听器", "护理协调", "用药提醒", "人形机器人", "养老人才培训", "康复器械", "金融理财", "慢病管理", "健康服务平台", "家政生活服务", "保险", "诊所", "SDOH", "个性化营养", "养老信息平台", "心理健康", "更年期", "睡眠监测"],
    },
    "智能科技": {
        "label": "智能科技",
        "l2": ["SaaS", "跌倒监测", "AI", "机器人", "智能硬件", "陪伴社交", "慢病管理", "康复器械", "人形机器人", "紧急呼叫", "护理协调", "远程医疗", "保险", "健康服务平台", "AI医疗", "睡眠监测", "认知训练", "糖尿病管理", "养老信息平台", "就业", "健身", "个性化营养", "文娱", "金融理财", "心理健康", "视觉辅助", "上门", "康复医疗", "VC", "助听器", "护理者支持", "兴趣社群", "膳食配送", "SDOH", "远程护理", "服装鞋帽", "保险科技", "用药管理", "远程监护", "神经调控", "养老运营", "轮椅", "用药提醒", "适老化", "居家护理", "遗产规划"],
    },
    "消费品": {
        "label": "消费品",
        "l2": ["智能硬件", "康复器械", "美妆护肤", "跌倒监测", "助行器", "服装鞋帽", "尿失禁", "个人护理", "适老化", "纸尿裤", "睡眠监测", "神经调控", "慢病管理", "助听器", "轮椅", "眼镜", "助听辅具", "远程医疗", "紧急呼叫", "AI", "视觉辅助", "SaaS", "护理床", "陪伴社交", "机器人", "外骨骼", "康复医疗", "保险", "远程监护", "体检筛查", "行业媒体", "居家护理", "医疗器械", "糖尿病管理", "认知筛查", "更年期"],
    },
    "渠道零售": {
        "label": "渠道零售",
        "l2": ["零售", "电商", "垂直电商"],
    ...
    "金融保险": {
        "label": "金融保险",
        "l2": ["保险", "金融理财", "保险科技", "SaaS", "遗产规划", "健康服务平台", "长护险经办", "慢病管理", "远程医疗", "居家护理", "诊所", "陪伴社交", "心理健康", "养老运营", "持续照料社区", "智能硬件", "居家医疗", "认知训练", "陪诊", "用药管理", "养老咨询", "康复器械", "家政生活服务", "个性化营养", "膳食配送", "AI", "用药提醒"],
    },
    "食品营养": {
        "label": "食品营养",
        "l2": ["保健品", "营养食品", "维生素矿物质", "膳食配送", "个性化营养", "慢病管理", "功能性食品", "中药滋补", "养老膳食", "膳食补充剂", "特医食品", "药品", "保险", "SaaS", "居家护理", "AI", "认知症", "陪伴社交", "养老咨询"],
    },
}
