...
ENTERPRISE_CATEGORIES = {
    "产业资本": ["VC", "产业基金", "养老REIT", "养老信息平台", "养老咨询", "行业媒体", "行业研究"],
    "养老服务": ["CCRC", "专业护理", "养老机构", "家政", "居家护理", "康养地产", "护工培训", "护工平台", "护理协调", "殡葬", "照护支持", "远程护理", "适老化", "陪伴服务", "陪诊", "出行助老"],
    "医疗健康": ["AI医疗", "SDOH", "中医养生", "体检筛查", "医疗器械", "呼吸", "安宁疗护", "居家医疗", "居家康复", "康复医疗", "心理健康", "心血管", "慢病管理", "护士上门", "护士派遣", "智能药盒", "更年期", "用药提醒", "用药管理", "睡眠监测", "糖尿病", "肾病", "药品", "药品配送", "视觉辅助", "认知症", "认知筛查", "认知训练", "诊所", "远程医疗", "远程监护"],
    "康复辅具": ["助听器", "助听辅具", "助行器", "外骨骼", "康复器械", "护理床", "轮椅"],
    "文娱社交": ["健身", "兴趣社群", "就业", "教育", "文娱", "旅游", "相亲", "短视频", "社区", "资讯门户", "邻里社交", "陪伴机器人", "陪伴社交"],
    "智能科技": ["AI", "SaaS", "人形机器人", "养老", "可穿戴监测", "智能家居", "机器人", "紧急呼叫", "跌倒监测"],
    "消费品": ["个人护理", "尿失禁", "智能硬件", "服装鞋帽", "眼镜", "纸尿裤", "美妆护肤"],
    "渠道零售": ["垂直电商", "电商", "零售"],
    "金融保险": ["保险", "保险科技", "遗产规划", "金融理财", "长护险"],
    "食品营养": ["个性化营养", "中药滋补", "保健品", "养老膳食", "功能性食品", "抗衰", "特医食品", "维生素矿物质", "膳食补充剂", "膳食配送", "营养食品"],
}
