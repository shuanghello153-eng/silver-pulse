...
NEWS_EVENT_TYPES = {
    ...
    "IPO": {"label": "IPO", "desc": "企业首次公开募股、上市"},
    "其他事件": {"label": "其他事件", "desc": "不属于以上类型的重要事件（含人事变动）"},
}
...
SOURCES = {
    ...
    "silvereco": {
        ...
        "l2_channels": [
            ...
            ("silvertech_summit", "https://www.silvereco.org/festival/en/silvertech-summit/", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
    ...
    "agetechx": {
        "name": "AgeTechX",
        "l1_domain": "agetechx.com",
        "l2_channels": [
            ("blog", "https://agetechx.com/blog/", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
        "notes": "柏林 AgeTech 加速器博客，系统盘点欧洲护理机器人/陪伴AI公司与融资",
        "ingest_time": "2026-07-16",
    },
    "beauhurst": {
        "name": "Beauhurst",
        "l1_domain": "beauhurst.com",
        "l2_channels": [
            ("blog", "https://www.beauhurst.com/blog/", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
        "notes": "英国高成长企业数据平台，Top AgeTech Companies 榜单与股权融资数据",
        "ingest_time": "2026-07-16",
    },
    "aal_programme": {
        "name": "AAL Programme (Active & Assisted Living)",
        "l1_domain": "aal-europe.eu",
        "l2_channels": [
            ("news_events", "https://www.aal-europe.eu/stay-up-date/news-events/", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
        "notes": "欧盟积极与辅助生活计划官网，16年资助300+项目/2000家中小企业，含成功案例与公司列表",
        "ingest_time": "2026-07-16",
    },
    "birdhouse_agetech": {
        "name": "Birdhouse (AgeTech in Europe)",
        "l1_domain": "gobirdhouse.com",
        "l2_channels": [
            ("agetech", "https://www.gobirdhouse.com/category/agetech/", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
        "notes": "比利时加速器专设 AgeTech in Europe 赛道，按 cohort 列欧洲 AgeTech 初创",
        "ingest_time": "2026-07-16",
    },
    "silvereco_com": {
        "name": "SilverEco & Ageing Well (Festival/Media)",
        "l1_domain": "silvereco.com",
        "l2_channels": [
            ("agetech_awards", "https://silvereco.com/silvereco-international-awards-2026-nominees-in-the-agetech-ai-digital-innovation-for-ageing-well-category/", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
        "notes": "欧洲银发经济节庆/媒体站，设 SilverTech & AI Summit 与 AgeTech/AI 奖项提名公司列表（与在库 silvereco.fr 不同域，按栏目独立分别保留）",
        "ingest_time": "2026-07-16",
    },
    "eit_health": {
        "name": "EIT Health",
        "l1_domain": "eithealth.eu",
        "l2_channels": [
            ("news", "https://www.eithealth.eu/news", "manual"),
        ],
        "tier": 2,
        "region": "overseas",
        "notes": "欧洲健康创新网络，healthy ageing/elder care 初创资助与 Catalyst 奖报道",
        "ingest_time": "2026-07-16",
    },
    "audio_infos_365": {
        "name": "Audio Infos 365",
        "l1_domain": "audioinfos365.fr",
        "l2_channels": [
            ("actualites", "https://www.audioinfos365.fr/actualites/", "manual"),
        ],
        "tier": 3,
        "region": "overseas",
        "notes": "法国助听/听力专业媒体，覆盖 AI 助听器、老年听力下降、EssilorLuxottica Nuance Audio 等",
        "ingest_time": "2026-07-16",
    },
    "eurobotics": {
        "name": "euRobotics",
        "l1_domain": "eu-robotics.net",
        "l2_channels": [
            ("news", "https://eu-robotics.net/news/", "manual"),
        ],
        "tier": 3,
        "region": "overseas",
        "notes": "欧洲机器人协会新闻室，含 ERF 展会与护理/陪伴机器人，整体噪音偏高，作展会/公司反查用",
        "ingest_time": "2026-07-16",
    },
    "gerontechnology_journal": {
        "name": "Gerontechnology Journal",
        "l1_domain": "journal.gerontechnology.org",
        "l2_channels": [
            ("current", "https://journal.gerontechnology.org/currentIssueContent.aspx", "manual"),
        ],
        "tier": 3,
        "region": "overseas",
        "notes": "国际 Gerontechnology 学会官方期刊，专门老龄化+技术研究/新闻，可作技术深度源",
        "ingest_time": "2026-07-16",
    },
    "interreg_europe": {
        "name": "Interreg Europe (Silver Up)",
        "l1_domain": "interregeurope.eu",
        "l2_channels": [
            ("news", "https://www.interregeurope.eu/news-events/news/", "manual"),
        ],
        "tier": 3,
        "region": "overseas",
        "notes": "欧盟跨区域项目 Silver Up 银发经济新闻，政策与区域案例",
        "ingest_time": "2026-07-16",
    },
    "age_platform": {
        "name": "AGE Platform Europe",
        "l1_domain": "age-platform.eu",
        "l2_channels": [
            ("news_resources", "https://www.age-platform.eu/news-resources/", "manual"),
        ],
        "tier": 3,
        "region": "overseas",
        "notes": "欧洲最大老年人权益 NGO，数字包容/年龄友好环境/ageing 政策，作欧盟政策反查",
        "ingest_time": "2026-07-16",
    },
    "digitalhealth_net": {
        "name": "Digital Health (UK)",
        "l1_domain": "digitalhealth.net",
        "l2_channels": [
            ("home", "https://www.digitalhealth.net/", "manual"),
        ],
        "tier": 3,
        "region": "overseas",
        "notes": "英国数字健康媒体，含数字居家护理/远程监护/Cera 护理机器人等银发报道，NHS 噪音偏大仅挑银发稿",
        "ingest_time": "2026-07-16",
    },
    # === 新增：2026-07-25 信源治理 W5-W11 合入（研究员实查+独立校验，collection_method=manual 待资讯AI激活）===
    "calcalistech_com": {
        "name": "CTech by Calcalist",
        "l1_domain": "calcalistech.com",
        "l2_channels": [("col1", "https://www.calcalistech.com/ctechnews/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "以色列科技财经权威，日更，AgeTech融资/产品报道；W5",
        "ingest_time": "2026-07-25",
    },
    "ourcrowd_com": {
        "name": "OurCrowd Startup News",
        "l1_domain": "ourcrowd.com",
        "l2_channels": [("col1", "https://www.ourcrowd.com/startup-news/news", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "健康/老化投资组合动态，高频；W5",
        "ingest_time": "2026-07-25",
    },
    "startupnationcentral_org": {
        "name": "Start-Up Nation Central",
        "l1_domain": "startupnationcentral.org",
        "l2_channels": [("col1", "https://startupnationcentral.org/hub/blog/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "Health Tech博客+Finder数据库(7200+初创)，AgeTech企业发现器；W5",
        "ingest_time": "2026-07-25",
    },
    "kedem_israel_org": {
        "name": "Kedem Hub",
        "l1_domain": "kedem-israel.org",
        "l2_channels": [("col1", "https://kedem-israel.org/innovation/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "AgeTech加速器，连接230+养老社区做POC；W5；低频组织源",
        "ingest_time": "2026-07-25",
    },
    "intuitionrobotics_com": {
        "name": "Intuition Robotics Blog",
        "l1_domain": "intuitionrobotics.com",
        "l2_channels": [("col1", "https://www.intuitionrobotics.com/blog", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "ElliQ老年AI陪伴机器人标杆厂商博客；W5",
        "ingest_time": "2026-07-25",
    },
    "joint_kaigo_com": {
        "name": "介護ニュース JOINT",
        "l1_domain": "joint-kaigo.com",
        "l2_channels": [("col1", "https://www.joint-kaigo.com/articles/category/介護経営/", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "日本介护产业日更专业媒体；W6；原/articles/为404，此URL为校验修正后实测200",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "care_news_jp": {
        "name": "ケアニュース Care News",
        "l1_domain": "care-news.jp",
        "l2_channels": [("col1", "https://www.care-news.jp/news", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "介护保险/报酬改定/福祉用具日更；AGECLUB反查证实的一手出处；W6",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "kaigokeieigakkai_jp": {
        "name": "日本介護経営学会",
        "l1_domain": "kaigokeieigakkai.jp",
        "l2_channels": [("col1", "https://kaigokeieigakkai.jp/category/お知らせ/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "介护经营学术，AI分科会等前沿议题；W6；更新偏会议通知",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "wam_go_jp": {
        "name": "WAM 経営サポート",
        "l1_domain": "wam.go.jp",
        "l2_channels": [("col1", "https://www.wam.go.jp/hp/keiei-report-r6/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "介护设施经营统计权威年报（特養/老健/医療法人）；W6；年度/半年度PDF报告",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "eclat_hpplus_jp": {
        "name": "Web エクラ eclat",
        "l1_domain": "eclat.hpplus.jp",
        "l2_channels": [("col1", "https://eclat.hpplus.jp/lifestyle/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "45+女性生活方式日更，文娱社交★★★；W6",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "welmo_co_jp": {
        "name": "ウェルモ Welmo News",
        "l1_domain": "welmo.co.jp",
        "l2_channels": [("col1", "https://welmo.co.jp/news/list/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "介护科技公司动态（融资/提携）；W6；校验降档T2→T3（公司PR非独立媒体）",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "thinkadvisor_com": {
        "name": "ThinkAdvisor Retirement",
        "l1_domain": "thinkadvisor.com",
        "l2_channels": [("col1", "https://www.thinkadvisor.com/retirement/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "退休金融顾问媒体（SS/Medicare/年金）；W7；Cloudflare反爬，采集端需UA策略",
        "ingest_time": "2026-07-25",
    },
    "planadviser_com": {
        "name": "PLANADVISER Advisory M&A",
        "l1_domain": "planadviser.com",
        "l2_channels": [("col1", "https://www.planadviser.com/tag/advisory-ma-news/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "退休顾问行业并购专栏，周更，选题价值最高；W7",
        "ingest_time": "2026-07-25",
    },
    "plansponsor_com": {
        "name": "PLANSPONSOR News",
        "l1_domain": "plansponsor.com",
        "l2_channels": [("col1", "https://www.plansponsor.com/news/", "manual"), ("col2", "https://www.plansponsor.com/news/compliance/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "PRT/ERISA/SECURE2.0退休计划权威；W7；URL已从首页修正为栏目直链（2026-07-25实测在更）",
        "ingest_time": "2026-07-25",
    },
    "retirementincomejournal_com": {
        "name": "Retirement Income Journal",
        "l1_domain": "retirementincomejournal.com",
        "l2_channels": [("col1", "https://retirementincomejournal.com/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "退休收入/年金深度+并购（Empower收购Milliman退休业务等）；W7；根域即新闻流",
        "ingest_time": "2026-07-25",
    },
    "healthcaredive_com": {
        "name": "Healthcare Dive Payers",
        "l1_domain": "healthcaredive.com",
        "l2_channels": [("col1", "https://www.healthcaredive.com/topic/payers/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "Medicare/UnitedHealth/CVS等支付方与并购；W7",
        "ingest_time": "2026-07-25",
    },
    "kiplinger_com": {
        "name": "Kiplinger Retirement",
        "l1_domain": "kiplinger.com",
        "l2_channels": [("col1", "https://www.kiplinger.com/retirement", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "消费者端退休理财（LTC/年金/Medicare/SS），免费全文；W7",
        "ingest_time": "2026-07-25",
    },
    "pehub_com": {
        "name": "PE Hub Healthcare",
        "l1_domain": "pehub.com",
        "l2_channels": [("col1", "https://www.pehub.com/sectors/healthcare/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "PE医疗养老交易快讯；W7；部分深文需注册非硬墙",
        "ingest_time": "2026-07-25",
    },
    "housingwire_com": {
        "name": "HousingWire RMD",
        "l1_domain": "housingwire.com",
        "l2_channels": [("col1", "https://www.housingwire.com/tag/reverse-mortgage/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "反向抵押贷款（HECM/CFPB），老年金融特色赛道；W7",
        "ingest_time": "2026-07-25",
    },
    "reversemortgage_org": {
        "name": "NRMLA",
        "l1_domain": "reversemortgage.org",
        "l2_channels": [("col1", "https://www.reversemortgage.org/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "反向抵押协会教育/行业动态；W7；首页例外（无独立新闻栏）",
        "ingest_time": "2026-07-25",
    },
    "seniortimes_co_kr": {
        "name": "시니어타임스 Senior Times",
        "l1_domain": "seniortimes.co.kr",
        "l2_channels": [("col1", "http://www.seniortimes.co.kr", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "韩国综合银发门户日更（福祉/经济/健康/理财/IT），韩国空白首填；W8；韩文",
        "lang": "ko",
        "ingest_time": "2026-07-25",
    },
    "khidi_or_kr": {
        "name": "KHIDI 韩国保健产业振兴院",
        "l1_domain": "khidi.or.kr",
        "l2_channels": [("col1", "https://www.khidi.or.kr/eps", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "高龄亲和产业/智慧照护政府权威源；W8；韩文",
        "lang": "ko",
        "ingest_time": "2026-07-25",
    },
    "channelnewsasia_com": {
        "name": "CNA Ageing",
        "l1_domain": "channelnewsasia.com",
        "l2_channels": [("col1", "https://www.channelnewsasia.com/topic/ageing", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "新加坡权威媒体ageing专题；W8；数月级低频，作专题源",
        "ingest_time": "2026-07-25",
    },
    "saga_co_uk": {
        "name": "Saga Magazine",
        "l1_domain": "saga.co.uk",
        "l2_channels": [("col1", "https://www.saga.co.uk/magazine", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "英国50+标杆生活方式日更，文娱社交★★★；W8",
        "ingest_time": "2026-07-25",
    },
    "notretemps_com": {
        "name": "Notre Temps",
        "l1_domain": "notretemps.com",
        "l2_channels": [("col1", "https://www.notretemps.com", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "法国退休/银发旗舰刊高频（健康/法律/钱/退休），文娱★★★；W8；法文",
        "lang": "fr",
        "ingest_time": "2026-07-25",
    },
    "apotheken_umschau_de": {
        "name": "Senioren Ratgeber",
        "l1_domain": "apotheken-umschau.de",
        "l2_channels": [("col1", "https://www.apotheken-umschau.de/unsere-marken/senioren-ratgeber/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "德国老年指南（健康/护理/政经）；W8；德文",
        "lang": "de",
        "ingest_time": "2026-07-25",
    },
    "carehomeprofessional_com": {
        "name": "Care Home Professional",
        "l1_domain": "carehomeprofessional.com",
        "l2_channels": [("col1", "https://www.carehomeprofessional.com", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "英国养老院B2B权威日更（CQC/并购/运营）；W8",
        "ingest_time": "2026-07-25",
    },
    "caremanagementmatters_co_uk": {
        "name": "Care Management Matters",
        "l1_domain": "caremanagementmatters.co.uk",
        "l2_channels": [("col1", "http://www.caremanagementmatters.co.uk/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "英国社会照护管理媒体日更；W8",
        "ingest_time": "2026-07-25",
    },
    "homecareinsight_co_uk": {
        "name": "Home Care Insight",
        "l1_domain": "homecareinsight.co.uk",
        "l2_channels": [("col1", "https://www.homecareinsight.co.uk", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "英国居家照护专业新闻日更；W8",
        "ingest_time": "2026-07-25",
    },
    "zoomer_com": {
        "name": "Zoomer",
        "l1_domain": "zoomer.com",
        "l2_channels": [("col1", "https://www.everythingzoomer.com", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "加拿大45+标杆媒体日更（健康/理财/旅游/文化）；W8；有效域为zoomer.com，everythingzoomer.com为别名，去重按zoomer.com",
        "ingest_time": "2026-07-25",
    },
    "australianageingagenda_com_au": {
        "name": "Australian Ageing Agenda",
        "l1_domain": "australianageingagenda.com.au",
        "l2_channels": [("col1", "https://www.australianageingagenda.com.au", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "澳洲养老权威独立媒体日更；W8",
        "ingest_time": "2026-07-25",
    },
    "hellocare_com_au": {
        "name": "HelloCare",
        "l1_domain": "hellocare.com.au",
        "l2_channels": [("col1", "https://hellocare.com.au", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "澳洲养老新闻+照护者家属社群；W8",
        "ingest_time": "2026-07-25",
    },
    "alzheimers_org_uk": {
        "name": "Alzheimer's Society News",
        "l1_domain": "alzheimers.org.uk",
        "l2_channels": [("col1", "https://www.alzheimers.org.uk/about-us/news-and-media/latest-news", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "英国认知症权威机构新闻；W8；与库内alz.org/alzheimers.net不同域",
        "ingest_time": "2026-07-25",
    },
    "alzheimersresearchuk_org": {
        "name": "Alzheimer's Research UK News",
        "l1_domain": "alzheimersresearchuk.org",
        "l2_channels": [("col1", "https://www.alzheimersresearchuk.org/news", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "认知症研究新闻（AAIC等）；W8",
        "ingest_time": "2026-07-25",
    },
    "ageinplacetech_com": {
        "name": "Aging and Health Technology Watch",
        "l1_domain": "ageinplacetech.com",
        "l2_channels": [("col1", "https://www.ageinplacetech.com/blog", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "Laurie Orlov，AgeTech最资深独立分析师，周更，观点鲜明契合反常识选题；BM；小爽书签背书",
        "ingest_time": "2026-07-25",
    },
    "globalcoalitiononaging_com": {
        "name": "GCOA News & Events",
        "l1_domain": "globalcoalitiononaging.com",
        "l2_channels": [("col1", "https://globalcoalitiononaging.com/news-events/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "全球商业老龄化联盟：政策信号+跨国企业动向；BM；/newsroom/是404勿用",
        "ingest_time": "2026-07-25",
    },
    "ifs_org_uk": {
        "name": "IFS Retirement Research",
        "l1_domain": "ifs.org.uk",
        "l2_channels": [("col1", "https://ifs.org.uk/tags/retirement", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "英国顶级智库养老金/退休研究，欧洲×老年金融空白首填；BM",
        "ingest_time": "2026-07-25",
    },
    "cao_go_jp": {
        "name": "内閣府 高齢社会白書",
        "l1_domain": "cao.go.jp",
        "l2_channels": [("col1", "https://www8.cao.go.jp/kourei/whitepaper/index-w.html", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "日本老龄社会最权威年度数据（令和8年版已发布）；BM；年更",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "mhlw_go_jp": {
        "name": "厚生労働省 介護・高齢者福祉",
        "l1_domain": "mhlw.go.jp",
        "l2_channels": [("col1", "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/hukushi_kaigo/kaigo_koureisha/index.html", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "介护保险制度一手政策源+介護DX专栏，月更；BM",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "asaging_org": {
        "name": "ASA Generations",
        "l1_domain": "asaging.org",
        "l2_channels": [("col1", "https://generations.asaging.org/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "美国老龄化协会核心刊物（季刊+博客）；BM；偶发人机验证，复测已通过",
        "ingest_time": "2026-07-25",
    },
    "acl_gov": {
        "name": "ACL Announcements",
        "l1_domain": "acl.gov",
        "l2_channels": [("col1", "https://acl.gov/news-and-events/announcements", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "Older Americans Act主管机构拨款/政策公告；BM；Azure网关反爬，首采建议浏览器验证",
        "ingest_time": "2026-07-25",
    },
    "65ymas_com": {
        "name": "65ymás",
        "l1_domain": "65ymas.com",
        "l2_channels": [("col1", "https://65ymas.com", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "文娱社交/活力老人；西班牙65+人群日报，整站垂直可收首页",
        "ingest_time": "2026-07-25",
    },
    "omroepmax_nl": {
        "name": "Omroep MAX",
        "l1_domain": "omroepmax.nl",
        "l2_channels": [("col1", "https://omroepmax.nl", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "文娱社交/活力老人；荷兰公共广播50+频道",
        "ingest_time": "2026-07-25",
    },
    "aeldresagen_dk": {
        "name": "Ældre Sagen Nyheder",
        "l1_domain": "aeldresagen.dk",
        "l2_channels": [("col1", "https://www.aeldresagen.dk/maerkesager-og-resultater/presse/nyheder", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "文娱社交/活力老人；丹麦最大老年组织新闻台",
        "ingest_time": "2026-07-25",
    },
    "senioren_se": {
        "name": "Senioren (SPF Seniorerna)",
        "l1_domain": "senioren.se",
        "l2_channels": [("col1", "https://www.senioren.se", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "文娱社交/活力老人；瑞典最大老年组织会员杂志网",
        "ingest_time": "2026-07-25",
    },
    "en_antaranews_com": {
        "name": "ANTARA Elderly Population",
        "l1_domain": "en.antaranews.com",
        "l2_channels": [("col1", "https://en.antaranews.com/tag/elderly-population", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "老龄化政策/银发经济；印尼国家通讯社英文老龄标签页",
        "ingest_time": "2026-07-25",
    },
    "seoulz_com": {
        "name": "SeoulZ Silver Economy",
        "l1_domain": "seoulz.com",
        "l2_channels": [("col1", "https://www.seoulz.com/?s=silver+economy", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "银发经济深稿；URL已修正:搜索列表页直链(原首页不合规)；低频但为选题级长文源",
        "lang": "ko",
        "ingest_time": "2026-07-25",
    },
    "populationnext_substack_com": {
        "name": "Population Next",
        "l1_domain": "populationnext.substack.com",
        "l2_channels": [("col1", "https://populationnext.substack.com/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "人口结构/银发商业趋势；Bradley Schurman(《The Super Age》作者)",
        "ingest_time": "2026-07-25",
    },
    "longevity_stanford_edu": {
        "name": "Stanford SCL Magazine",
        "l1_domain": "longevity.stanford.edu",
        "l2_channels": [("col1", "https://longevity.stanford.edu/subscribe/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "长寿经济研究；实测已更至2026-07 Issue12",
        "ingest_time": "2026-07-25",
    },
    "thebusinessofage_com": {
        "name": "The Business of Age",
        "l1_domain": "thebusinessofage.com",
        "l2_channels": [("col1", "https://www.thebusinessofage.com/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "老龄消费商业；Bateson教授，实测#257期(2026-03)在更",
        "ingest_time": "2026-07-25",
    },
    "parasolalliance_com": {
        "name": "Raising Tech",
        "l1_domain": "parasolalliance.com",
        "l2_channels": [("col1", "https://parasolalliance.com/podcast", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "智能养老/AgeTech；130+期，深访AgeTech企业",
        "ingest_time": "2026-07-25",
    },
    "ilcuk_org_uk": {
        "name": "ILC UK",
        "l1_domain": "ilcuk.org.uk",
        "l2_channels": [("col1", "https://ilcuk.org.uk/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "长寿经济政策智库；2026-07-17在更",
        "ingest_time": "2026-07-25",
    },
    "techenhancedlife_substack_com": {
        "name": "Tech-enhanced Life",
        "l1_domain": "techenhancedlife.substack.com",
        "l2_channels": [("col1", "https://techenhancedlife.substack.com/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "适老产品评测；60-90岁用户社区实测适老科技",
        "ingest_time": "2026-07-25",
    },
    "josephcoughlin_com": {
        "name": "Joe Coughlin / MIT AgeLab",
        "l1_domain": "josephcoughlin.com",
        "l2_channels": [("col1", "https://josephcoughlin.com", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "长寿经济观点；《The Longevity Economy》作者观点聚合",
        "ingest_time": "2026-07-25",
    },
    "cose_org_ph": {
        "name": "COSE (Coalition of Services of the Elderly)",
        "l1_domain": "cose.org.ph",
        "l2_channels": [("col1", "https://cose.org.ph/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "老年NGO新闻台；菲律宾老人民间联盟(1989起)，Active and Healthy Ageing/社区韧性/长者社群",
        "ingest_time": "2026-07-25",
    },
    "ncsc_gov_ph": {
        "name": "NCSC News (National Commission of Senior Citizens)",
        "l1_domain": "ncsc.gov.ph",
        "l2_channels": [("col1", "https://www.ncsc.gov.ph/news", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "政府老龄政策门户；菲律宾国家老人委员会官方新闻台，长者权益/社会养老金/原居安老政策",
        "ingest_time": "2026-07-25",
    },
    "hoinguoicaotuoi_vn": {
        "name": "Hội Người cao tuổi Việt Nam (越南老年协会中央官网)",
        "l1_domain": "hoinguoicaotuoi.vn",
        "l2_channels": [("col1", "https://hoinguoicaotuoi.vn", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "老年协会官方新闻台；越南老协中央网站，银发经济/文体/跨代俱乐部(日更级)",
        "ingest_time": "2026-07-25",
    },
    "golansia_com": {
        "name": "GOLANSIA",
        "l1_domain": "golansia.com",
        "l2_channels": [("col1", "https://golansia.com", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "垂直乐龄健康生活门户；印尼专注乐龄(lansia)群体门户，Tips Lansia/健康幸福/防认知衰退(日更)",
        "ingest_time": "2026-07-25",
    },
    "kompas_com": {
        "name": "Kompas – Tag \"Lansia\"",
        "l1_domain": "kompas.com",
        "l2_channels": [("col1", "https://www.kompas.com/tag/lansia", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "主流媒体乐龄专题聚合；印尼第一大报 Kompas 乐龄标签页，活跃老化报道与政策聚合",
        "ingest_time": "2026-07-25",
    },
    "aic_sg": {
        "name": "AIC – Age Well (原 C3A 活跃老化门户)",
        "l1_domain": "aic.sg",
        "l2_channels": [("col1", "https://www.aic.sg/community/active-ageing/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "政府活跃老化门户；新加坡活跃老化国家级门户(原C3A)，终身学习/银发志愿/Active Ageing Centres；校验:原计划活动证据偏弱，已弱化为门户性质描述",
        "ingest_time": "2026-07-25",
    },
    "healthyageing_org": {
        "name": "MHAS (Malaysian Healthy Ageing Society)",
        "l1_domain": "healthyageing.org",
        "l2_channels": [("col1", "https://healthyageing.org/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "健康老化协会新闻台；马来西亚健康老化非营利协会，社区乐龄中心/年龄友好城市(MCHA2026大会)；校验修正:原子页/news-and-publications/返垃圾页，改引根域",
        "ingest_time": "2026-07-25",
    },
    "fopdev_or_th": {
        "name": "FOPDEV (Foundation for Older Persons' Development)",
        "l1_domain": "fopdev.or.th",
        "l2_channels": [("col1", "https://fopdev.or.th/en/home", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "老年发展基金会；泰国老发基金会，乐龄俱乐部+aging-in-place社会企业(校验:企业名应为Community-based Home Care，非Buddy Home Care)",
        "ingest_time": "2026-07-25",
    },
    "hepingribao_id": {
        "name": "和平日报 (Heping Ribao) 乐龄社区报道",
        "l1_domain": "hepingribao.id",
        "l2_channels": [("col1", "https://www.hepingribao.id/home/2026/05/27/%E8%90%AC%E9%9A%86%E5%B8%82%E5%8D%97%E5%8D%80singgasana-pradana%E6%A8%82%E9%BD%A1%E5%B1%85%E6%B0%91%E6%AD%A1%E6%A8%82%E6%99%A8%E9%81%8B/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "华文社区媒体；印尼华文大报乐龄社区报道，万隆乐龄居民晨运/Line Dance/量血压",
        "ingest_time": "2026-07-25",
    },
    "mohw_go_kr": {
        "name": "保健福祉部 MOHW (韩国) 英文新闻台",
        "l1_domain": "mohw.go.kr",
        "l2_channels": [("col1", "https://www.mohw.go.kr/eng/", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "中央政府部委；韩国保健福祉部政策/新闻总入口，老龄化与统合护理核心源",
        "ingest_time": "2026-07-25",
    },
    "nps_or_kr": {
        "name": "国民年金公团 NPS (韩国)",
        "l1_domain": "nps.or.kr",
        "l2_channels": [("col1", "https://www.nps.or.kr/main.do", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "准政府·公团；韩国国民年金(公共养老金)官方机构，统计与指南权威",
        "ingest_time": "2026-07-25",
    },
    "kordi_or_kr": {
        "name": "韩国老人人力开发院 KOI (原 KoAging)",
        "l1_domain": "kordi.or.kr",
        "l2_channels": [("col1", "https://www.kordi.or.kr/content.do?cmsId=168", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "准政府·公团；韩国老年就业与老龄产业核心公团(原韩国老龄产业振兴院合并主体)",
        "ingest_time": "2026-07-25",
    },
    "www8_cao_go_jp": {
        "name": "内閣府 高齢社会対策 (日本)",
        "l1_domain": "www8.cao.go.jp",
        "l2_channels": [("col1", "https://www8.cao.go.jp/kourei/index.html", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "中央政府·政策统括官；日本老龄化综合对策与《高齢社会白書》法定发布机构",
        "ingest_time": "2026-07-25",
    },
    "meti_go_jp": {
        "name": "経済産業省 长期护理技术 (日本)",
        "l1_domain": "meti.go.jp",
        "l2_channels": [("col1", "https://www.meti.go.jp/english/press/2024/0628_004.html", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "中央政府部委；经产省×厚労省长期护理技术/照护机器人政策(静态2024政策页，建议后续补活栏目)",
        "ingest_time": "2026-07-25",
    },
    "fukushi_metro_tokyo_lg_jp": {
        "name": "東京都福祉局 高齢者 (日本·都道府県代表)",
        "l1_domain": "fukushi.metro.tokyo.lg.jp",
        "l2_channels": [("col1", "https://www.fukushi.metro.tokyo.lg.jp/kourei", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "都道府県政府；东京都老龄施策/认知症/介护窗口(代表都道府県老龄条例层级)",
        "ingest_time": "2026-07-25",
    },
    "ndrc_gov_cn": {
        "name": "国家发展和改革委员会 NDRC (中国)",
        "l1_domain": "ndrc.gov.cn",
        "l2_channels": [("col1", "https://www.ndrc.gov.cn/xwdt/spfg/zfzjt/202401/t20240122_1363612_ext.html", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "中央政府部委；中国银发经济顶层政策牵头部门(国办发〔2024〕1号主导编制；静态2024政策文)",
        "ingest_time": "2026-07-25",
    },
    "nhc_gov_cn": {
        "name": "国家卫生健康委 老龄健康司 NHC (中国)",
        "l1_domain": "nhc.gov.cn",
        "l2_channels": [("col1", "https://www.nhc.gov.cn/lljks/new_index.shtml", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "中央政府部委；中国老年健康与老龄健康政策主管司局",
        "ingest_time": "2026-07-25",
    },
    "swd_gov_hk": {
        "name": "香港社会福利署 安老服务 SWD",
        "l1_domain": "swd.gov.hk",
        "l2_channels": [("col1", "https://www.swd.gov.hk/en/pubsvc/elderly/", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "特区政府部门；香港安老服务(社区/院舍照顾、长者卡、服务券)权威入口",
        "ingest_time": "2026-07-25",
    },
    "ias_gov_mo": {
        "name": "澳门社会工作局 IAS",
        "l1_domain": "ias.gov.mo",
        "l2_channels": [("col1", "https://www.ias.gov.mo", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "特区政府部门；澳门长者服务与社会福利主管局",
        "ingest_time": "2026-07-25",
    },
    "mohw_gov_tw": {
        "name": "卫生福利部 MOHW (中国台湾)",
        "l1_domain": "mohw.gov.tw",
        "l2_channels": [("col1", "https://www.mohw.gov.tw/np-16-1.html", "manual")],
        "tier": 1,
        "region": "overseas",
        "notes": "政府部门；台湾老年福利/长期照护/国民年金主管部",
        "ingest_time": "2026-07-25",
    },
    "bokjinews_com": {
        "name": "Bokjinews (복지뉴스, 韩国)",
        "l1_domain": "bokjinews.com",
        "l2_channels": [("col1", "https://www.bokjinews.com", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "健康福祉通讯社；⚠️pending_manual；韩国保健福祉专业通讯社；根路径 Apache 404，待人工浏览器复核栏目活跃度",
        "ingest_time": "2026-07-25",
    },
    "minnanokaigo_com": {
        "name": "みんなの介護",
        "l1_domain": "minnanokaigo.com",
        "l2_channels": [("col1", "https://minnanokaigo.com/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "日本介护/照护新闻专栏，用户真浏览器复测可达；W5-W8 ⚠️升级(原403反爬)；2026-07-25 用户复测确认可达",
        "lang": "ja",
        "ingest_time": "2026-07-25",
    },
    "sgenable_sg": {
        "name": "SG Enable",
        "l1_domain": "sgenable.sg",
        "l2_channels": [("col1", "https://www.sgenable.sg/", "manual")],
        "tier": 3,
        "region": "overseas",
        "notes": "新加坡乐龄赋能政府机构，一手政策与生态；W5-W8 ⚠️升级(原连接失败)；2026-07-25 用户复测确认可达",
        "ingest_time": "2026-07-25",
    },
    "longevityisrael_org": {
        "name": "Longevity Israel",
        "l1_domain": "longevityisrael.org",
        "l2_channels": [("col1", "https://longevityisrael.org/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "以色列长寿/老龄化生态平台，2026-06 内容在更；W5-W8 ⚠️升级(原403反爬)；2026-07-25 用户复测确认可达",
        "ingest_time": "2026-07-25",
    },
    "ageingasia_com": {
        "name": "Ageing Asia",
        "l1_domain": "ageingasia.com",
        "l2_channels": [("col1", "https://ageingasia.com/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "亚太养老创新平台，WAF2027+多events在更；W5-W8 ⚠️升级(原JS渲染SPA)；2026-07-25 用户复测确认可达",
        "ingest_time": "2026-07-25",
    },
    "geektime_co_il": {
        "name": "Geektime (希伯来版)",
        "l1_domain": "geektime.co.il",
        "l2_channels": [("col1", "https://www.geektime.co.il/", "manual")],
        "tier": 2,
        "region": "overseas",
        "notes": "以色列科技财经希伯来语版，AgeTech融资报道；W5-W8 ⚠️升级(原Cloudflare反爬)；2026-07-25 用户复测确认可达(加载慢)",
        "lang": "he",
        "ingest_time": "2026-07-25",
    },
}
...
SILVER_STRONG_KEYWORDS = [
    # 中文（V8.0 新增：护理/家庭护理/家庭健康/社会健康因素）
    ...
    "社会健康因素",
    # 英文（V8.0 新增：Caregivers/Home Health/Home Health Care/Hospice Care/Palliative Care/skilled nursing care/SODH）
