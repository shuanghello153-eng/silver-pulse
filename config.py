...
ENTERPRISE_CATEGORIES = {
    "产业资本": {
        "label": "产业资本",
        "l2": ["行业媒体", "产业基金", "VC", "养老REIT", "养老信息平台", "养老咨询", "行业研究"],
    },
    "养老服务": {
        "label": "养老服务",
        "l2": ["居家护理", "陪伴服务", "养老运营", "适老化", "改造", "远程护理", "上门", "护理协调", "护工平台", "CCRC", "康养地产", "专业护理", "家政", "养老机构", "照护支持", "陪诊", "殡葬", "护工培训"],
    },
    "医疗健康": {
        "label": "医疗健康",
        "l2": ["认知训练", "药品", "认知数字疗法", "健康服务平台", "诊所", "睡眠监测", "护士上门", "安宁疗护", "远程医疗", "更年期", "体检筛查", "远程监护", "康复医疗", "居家医疗", "AI医疗", "慢病管理", "心理健康", "用药提醒", "神经调控", "糖尿病", "健康管理", "认知症", "SDOH", "抗衰老药物", "智能药盒", "药品配送", "医疗器械", "认知筛查", "视觉辅助", "用药管理", "居家康复", "护士派遣", "心血管", "认知症药品", "中医养生", "呼吸", "肾病"],
    },
    "康复辅具": {
        "label": "康复辅具",
        "l2": ["助听器", "助行器", "轮椅", "康复器械", "外骨骼", "护理床", "助听辅具"],
    },
    "文娱社交": {
        "label": "文娱社交",
        "l2": ["文娱短视频", "兴趣社群", "健身", "陪伴机器人", "文娱", "旅游", "教育", "资讯门户", "陪伴社交", "相亲", "社区", "就业", "邻里社交", "短视频"],
    },
    "智能科技": {
        "label": "智能科技",
        "l2": ["可穿戴监测", "SaaS", "跌倒监测", "机器人", "人形机器人", "AI", "紧急呼叫", "智能家居"],
    },
    "消费品": {
        "label": "消费品",
        "l2": ["智能硬件", "美妆护肤", "眼镜", "服装鞋帽", "尿失禁", "个人护理", "纸尿裤"],
    },
    "渠道零售": {
        "label": "渠道零售",
        "l2": ["零售", "电商", "垂直电商"],
    ...
    "金融保险": {
        "label": "金融保险",
        "l2": ["金融理财", "保险", "保险科技", "遗产规划", "长护险经办"],
    },
    "食品营养": {
        "label": "食品营养",
        "l2": ["保健品", "营养食品", "维生素矿物质", "膳食配送", "个性化营养", "养老膳食", "功能性食品", "膳食补充剂", "特医食品", "中药滋补"],
    },
}
